...
function Apostille_Certificate() {
          ...
          <Col md={8}>
            ...
            <div className="content ">
              ...
              >
                ...
                <p>
                  India, since 2005, is a member of the Hague Convention of
                  October 5, 1961 that abolished the requirement of legalization
                  of foreign public documents. Essentially, apostille is an
                  internationalattestation that is acceptable in about 92
                  countries, and most of the western world recognises Apostille.
                  Apostille stamp is a square shaped computer-generated sticker
                  stamp, pasted on reverse of the document by the Ministry of
                  External Affairs, Government of India. This is a unique
                  computer-generated stamp having a unique identification
                  number, through which any member country of the Hague
                  convention can check its authenticity online. Under normal
                  circumstances, once the document is apostilled, it does not
                  require to be attested further from the concerned embassy. If
                  a document is apostilled, it does not require to be attested.
                </p>
...
export default Apostille_Certificate;
